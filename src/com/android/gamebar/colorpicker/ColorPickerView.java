...
public class ColorPickerView extends View {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    showAlphaPanel = a.getBoolean(R.styleable.ColorPickerView_gamebar_alphaChannelVisible, false);
    alphaSliderText = a.getString(R.styleable.ColorPickerView_gamebar_alphaChannelText);
    sliderTrackerColor = a.getColor(R.styleable.ColorPickerView_gamebar_sliderColor, 0xFFBDBDBD);
    borderColor = a.getColor(R.styleable.ColorPickerView_gamebar_borderColor, 0xFF6E6E6E);
    a.recycle();
    ...
    mRequiredPadding = getResources().getDimensionPixelSize(R.dimen.gamebar_required_padding);
