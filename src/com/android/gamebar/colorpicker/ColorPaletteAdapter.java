...
class ColorPaletteAdapter extends BaseAdapter {
  ...
  private final class ViewHolder {
    ...
    ViewHolder(Context context) {
      ...
      colorPanelView = (ColorPanelView) view.findViewById(R.id.gamebar_color_panel_view);
      imageView = (ImageView) view.findViewById(R.id.gamebar_color_image_view);
    ...
    void setup(int position) {
      ...
      imageView.setImageResource(selectedPosition == position ? R.drawable.gamebar_preset_checked : 0);
      if (alpha != 255) {
