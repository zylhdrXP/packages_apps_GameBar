...
public class ColorPanelView extends View {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    shape = a.getInt(R.styleable.ColorPanelView_gamebar_colorShape, ColorShape.CIRCLE);
    showOldColor = a.getBoolean(R.styleable.ColorPanelView_gamebar_showOldColor, false);
    if (showOldColor && shape != ColorShape.CIRCLE) {
      throw new IllegalStateException("Color preview is only available in circle mode");
    }
    borderColor = a.getColor(R.styleable.ColorPanelView_gamebar_borderColor, DEFAULT_BORDER_COLOR);
    a.recycle();
    ...
    if (shape == ColorShape.CIRCLE) {
      Bitmap bitmap = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.gamebar_alpha)).getBitmap();
